...
@Entity
@Table(name = "standard_route_table")
...
public class StandardRoute extends BaseTenantEntity {
    ...
    private String standardGeometryOutbound;
    @Column(columnDefinition = "text")
    private String standardGeometryReturn;
    @ElementCollection
    @CollectionTable(
    ...
    public StandardRoute(UUID id, String routeName, String routeDescription, Double originLatitude, Double originLongitude, Double destinationLatitude, Double destinationLongitude, String standardGeometryOutbound, String standardGeometryReturn, GeneralStatus status, Instant createdAt, Instant updatedAt) {
        this.id = id;
        ...
        this.standardGeometryOutbound = standardGeometryOutbound;
        this.standardGeometryReturn = standardGeometryReturn;
        this.status = status;
    ...
    public String getStandardGeometryOutbound() {
        return standardGeometryOutbound;
    }

    public void setStandardGeometryOutbound(String standardGeometryOutbound) {
        this.standardGeometryOutbound = standardGeometryOutbound;
    }

    public String getStandardGeometryReturn() {
        return standardGeometryReturn;
    }

    public void setStandardGeometryReturn(String standardGeometryReturn) {
        this.standardGeometryReturn = standardGeometryReturn;
    }
