...
public class StudentRouteStopAssignment extends BaseTenantEntity {
    ...
    public StudentRouteStopAssignment(UUID id, Student student, RouteStop routeStop, StandardRoute standardRoute, TravelPeriod travelPeriod, TravelDirection travelDirection, Instant createdAt, Instant updatedAt) {
        this.id = id;
